...
const NhsLoginButton = ({ onClickAction, extraClasses }) => {
    ...
    return (
        <button
            className={
                'nhsuk-login-button ' +
                (focusState ? 'nhsuk-login-button-focus ' : 'nhsuk-login-button-non-focus ') +
                extraClasses
            }
            type="button"
            ...
            onTouchEnd={onBlur}
            onBlur={onBlur}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 343.48 59">
                <defs></defs>
                <title>{button.nhsLoginLabel}</title>
                <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                        ...
                        <path
                            className="cls-3"
                            d="M207.24,22.36V19.9h2.58v2.46Zm0,11.72V24.17h2.58v9.91Z"
                        />
                        <path
                            className="cls-3"
                        ...
                        <path
                            className="cls-3"
                            d="M309.91,22.36V19.9h2.58v2.46Zm0,11.72V24.17h2.58v9.91Z"
                        />
                        <path
                            className="cls-3"
